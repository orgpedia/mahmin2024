...
1. [mahmin2024-*.pdf.en.txt](flow/writeTxt_/output/): Orders in Marathi.

2. [mahmin2024-*.pdf.mr.txt](flow/writeTxt_/output/): Orders in English.
...
```
git clone https://github.com/orgpedia/mahmin2024.git
```
